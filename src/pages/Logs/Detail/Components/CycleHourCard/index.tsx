  ...
  return (
    <S.CycleHoursCard>
        <S.Col style={{width: '100%'}}>
          <S.Title>{cycleHour.start_hour} - {cycleHour.end_hour}: {CycleStatus[cycleHour.status_id]}</S.Title>
          <S.CycleHoursRow>
            <S.Col>
              <S.FixedRow>
                <DetailInfoCard title="Status" value={CycleStatus[cycleHour.status_id]} />
                <DetailInfoCard title="Duration" value={`${cycleHour.start_hour} - ${cycleHour.end_hour}`} />
